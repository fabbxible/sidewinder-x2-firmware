...
#define STRING_CONFIG_H_AUTHOR "Fabbxible, Season" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Sidewinder X2 Z Endstop"
 ...
 *
 */
#define TEMP_SENSOR_0 998 //map extend beyond 300c
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 19.0423 //Bi-metal 250C, with Silicone Sock
    #define DEFAULT_Ki  1.7124
    #define DEFAULT_Kd 52.9376
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 10, 35 }
